  ...
  def create
    ...
    respond_to do |format|
      if @test_passage.save
        format.html { redirect_to test_passage_url(@test_passage), notice: "Test passage was successfully created." }
  ...
  def update
    respond_to do |format|
      if @test_passage.update(test_passage_params)
        format.html { redirect_to test_passage_url(@test_passage), notice: "Test passage was successfully updated." }
